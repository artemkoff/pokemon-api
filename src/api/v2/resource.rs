...
pub trait ApiResourceList {
    ...
    async fn next_list(
        &self,
    ) -> Result<Option<Box<dyn ApiResourceList<ResourceType = Self::ResourceType>>>>;
...
pub trait ApiNamedResourceList {
    ...
    async fn next_list(
        &self,
    ) -> Result<Option<Box<dyn ApiNamedResourceList<ResourceType = Self::ResourceType>>>>;
    async fn previous_list(
        &self,
    ) -> Result<Option<Box<dyn ApiNamedResourceList<ResourceType = Self::ResourceType>>>>;
    ...
    ($list:tt for $model:tt with $res:tt) => {
        ...
        impl $crate::api::v2::resource::ApiResourceList for $list {
            ...
            async fn next_list(
                ...
                Option<
                    Box<
                        dyn $crate::api::v2::resource::ApiResourceList<
            ...
            > {
                match self.resource_list.next {
                    None => Ok(None),
                    Some(ref url) => Ok(Some(Box::new(Self::new(
                        self.client.clone(),
                        self.client
                            .request(url)
                            .await?
            ...
            fn resources(&self) -> Vec<Box<dyn ApiResource<ResourceType = Self::ResourceType>>> {
                let mut resources =
                    Vec::<Box<dyn ApiResource<ResourceType = Self::ResourceType>>>::new();
    ...
    ($list:tt for $model:tt with $res:tt) => {
        ...
        impl $crate::api::v2::resource::ApiNamedResourceList for $list {
            ...
            async fn next_list(
                ...
                Option<
                    Box<
                        dyn $crate::api::v2::resource::ApiNamedResourceList<
                            ResourceType = Self::ResourceType,
                        >,
                    >,
                >,
            ...
            fn resources(
                &self,
            ) -> Vec<Box<dyn ApiNamedResource<ResourceType = Self::ResourceType>>> {
                let mut resources =
                    Vec::<Box<dyn ApiNamedResource<ResourceType = Self::ResourceType>>>::new();
                for res in self.resource_list.results.iter() {
                    resources.push(Box::new($res::new(self.client.clone(), res.clone())));
                }
